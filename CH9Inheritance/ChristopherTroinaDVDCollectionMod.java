...
import CH9Inheritance.ChristopherTroinaDVDMod;

import java.util.ArrayList;
import java.util.Scanner;

/**
 * ChristopherTroinaDVDCollectionMod, Stores a collection of DVDs and Blu-Ray disks.
 * @author Christopher Troina
 */
public class ChristopherTroinaDVDCollectionMod {
    private ArrayList<ChristopherTroinaDVDMod> collection;
    private int count;
    private double totalCost;

    /**
     * Creates a new ChristopherTroinaDVDCollectionMod object
     */
    public ChristopherTroinaDVDCollectionMod(){
    ...
    public void addDVD(String title, String director, int year, double cost, boolean blueray){
        collection.add(new ChristopherTroinaDVDMod(title, director, year, cost, blueray));
        count++;
        totalCost+=cost;
    ...
    public String toString(){
        ...
        for(int i=0;i<count;i++) {
            ...
            String dvd=collection.get(i).toString();
